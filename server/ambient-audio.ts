...
export const AMBIENT_TRACKS: TrackDefinition[] = [
  {
    id: "joyful-morning",
    name: "Joyful Morning",
    description: "Bright, uplifting chimes to start your day with praise",
    durationSeconds: 30,
    layers: [
      { frequency: 523.25, amplitude: 0.10, detuneHz: 0.2, vibratoRate: 2.5, vibratoDepth: 3.0 },
      { frequency: 659.25, amplitude: 0.09, detuneHz: 0.15, vibratoRate: 3.0, vibratoDepth: 2.5 },
      { frequency: 783.99, amplitude: 0.07, detuneHz: 0.1, vibratoRate: 3.5, vibratoDepth: 2.0 },
      { frequency: 1046.5, amplitude: 0.04, detuneHz: 0.1, vibratoRate: 4.0, vibratoDepth: 1.5 },
      { frequency: 392.0, amplitude: 0.06, detuneHz: 0.15, vibratoRate: 2.0, vibratoDepth: 2.0 },
    ],
    fadeSeconds: 2,
    swellRate: 0.35,
    premium: false,
  },
  {
    id: "grateful-heart",
    name: "Grateful Heart",
    description: "Warm, cheerful harmonies for thankful reflection",
    durationSeconds: 30,
    layers: [
      { frequency: 440.0, amplitude: 0.09, detuneHz: 0.15, vibratoRate: 2.8, vibratoDepth: 2.5 },
      { frequency: 554.37, amplitude: 0.08, detuneHz: 0.1, vibratoRate: 3.2, vibratoDepth: 2.0 },
      { frequency: 659.25, amplitude: 0.07, detuneHz: 0.12, vibratoRate: 2.5, vibratoDepth: 2.2 },
      { frequency: 880.0, amplitude: 0.04, detuneHz: 0.08, vibratoRate: 3.8, vibratoDepth: 1.8 },
      { frequency: 329.63, amplitude: 0.05, detuneHz: 0.1, vibratoRate: 2.0, vibratoDepth: 1.5 },
    ],
    fadeSeconds: 2,
    swellRate: 0.30,
    premium: false,
  },
  {
    id: "sunday-light",
    name: "Sunday Light",
    description: "Sparkling, happy tones like sunlight through stained glass",
    durationSeconds: 30,
    layers: [
      { frequency: 587.33, amplitude: 0.09, detuneHz: 0.15, vibratoRate: 3.0, vibratoDepth: 2.8 },
      { frequency: 739.99, amplitude: 0.08, detuneHz: 0.1, vibratoRate: 3.5, vibratoDepth: 2.2 },
      { frequency: 880.0, amplitude: 0.06, detuneHz: 0.12, vibratoRate: 4.0, vibratoDepth: 2.0 },
      { frequency: 1174.66, amplitude: 0.03, detuneHz: 0.08, vibratoRate: 4.5, vibratoDepth: 1.5 },
      { frequency: 440.0, amplitude: 0.05, detuneHz: 0.1, vibratoRate: 2.5, vibratoDepth: 1.8 },
    ],
    fadeSeconds: 2,
    swellRate: 0.40,
    premium: false,

...
export const AMBIENT_TRACKS: TrackDefinition[] = [
  {
    ...
    description: "Soft, floating tones for quiet devotion",
    durationSeconds: 30,
    layers: [
      { frequency: 261.63, amplitude: 0.08 },
      { frequency: 329.63, amplitude: 0.06 },
      { frequency: 392.0, amplitude: 0.05 },
      { frequency: 523.25, amplitude: 0.03 },
    ],
    fadeSeconds: 6,
    swellRate: 0.04,
    premium: false,
  },
  {
    id: "gentle-waters",
    name: "Gentle Waters",
    description: "Calm, drifting sound like a quiet stream",
    durationSeconds: 30,
    layers: [
      { frequency: 293.66, amplitude: 0.07 },
      { frequency: 369.99, amplitude: 0.06 },
      { frequency: 440.0, amplitude: 0.05 },
      { frequency: 587.33, amplitude: 0.03 },
    ],
    fadeSeconds: 6,
    swellRate: 0.03,
    premium: false,
  },
  {
    id: "still-and-know",
    name: "Still and Know",
    description: "A soft, warm blanket of sound for prayer",
    durationSeconds: 30,
    layers: [
      { frequency: 220.0, amplitude: 0.07 },
      { frequency: 277.18, amplitude: 0.06 },
      { frequency: 329.63, amplitude: 0.05 },
      { frequency: 440.0, amplitude: 0.03 },
    ],
    fadeSeconds: 7,
    swellRate: 0.025,
    premium: false,
